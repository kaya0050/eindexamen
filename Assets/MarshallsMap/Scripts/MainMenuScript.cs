...
public class MainMenuScript : MonoBehaviour
{
    ...
    {
        // deze functie word aan een button gekoppeld en zorgt dat er 2 spelers in de scene zijn om mee te spelen.
        //SceneManager.LoadScene("GameScene");
    }

    public void StartGame3Player()
    {
        // deze functie word aan een button gekoppeld en zorgt dat er 3 spelers in de scene zijn om mee te spelen.
        //SceneManager.LoadScene("GameScene");
    }

    public void StartGame4Player()
    {
        // deze functie word aan een button gekoppeld en zorgt dat er 4 spelers in de scene zijn om mee te spelen.
        //SceneManager.LoadScene("GameScene");
    }
